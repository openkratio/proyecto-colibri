...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Group.acronym'
        db.alter_column(u'parliamentarygroup_group', 'acronym', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    models = {
        ...
        u'term.term': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
