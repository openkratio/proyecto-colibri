...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MemberParty.start_date'
        db.alter_column('member_memberparty', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MemberParty.substitute'
        db.alter_column('member_memberparty', 'substitute_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['member.Member']))

    def backwards(self, orm):

        # Changing field 'MemberParty.start_date'
        db.alter_column('member_memberparty', 'start_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'MemberParty.substitute'
        db.alter_column('member_memberparty', 'substitute_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['member.Member']))
    ...
    models = {
        ...
        'member.memberparty': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'None'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
