...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MemberParty.substitute'
        db.delete_column('member_memberparty', 'substitute_id')


    def backwards(self, orm):
        # Adding field 'MemberParty.substitute'
        db.add_column('member_memberparty', 'substitute',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='substitute', null=True, to=orm['member.Member']),
                      keep_default=False)
    ...
    models = {
        'member.member': {
            ...
            'parties': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['parliamentarygroup.Party']", 'through': "orm['member.MemberParty']", 'symmetrical': 'False'}),
