...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field votings on 'Initiative'
        m2m_table_name = db.shorten_name(u'initiatives_initiative_votings')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('initiative', models.ForeignKey(orm[u'initiatives.initiative'], null=False)),
            ('voting', models.ForeignKey(orm[u'vote.voting'], null=False))
        ))
        db.create_unique(m2m_table_name, ['initiative_id', 'voting_id'])


    def backwards(self, orm):
        # Removing M2M table for field votings on 'Initiative'
        db.delete_table(db.shorten_name(u'initiatives_initiative_votings'))
    ...
    models = {
        ...
        u'term.term': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 24, 0, 0)', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'roman': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 24, 0, 0)'})
        },
        u'vote.session': {
            'Meta': {'object_name': 'Session'},
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
