...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field author_group on 'Initiative'
        m2m_table_name = db.shorten_name(u'initiatives_initiative_author_group')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('initiative', models.ForeignKey(orm[u'initiatives.initiative'], null=False)),
            ('group', models.ForeignKey(orm[u'parliamentarygroup.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['initiative_id', 'group_id'])


    def backwards(self, orm):
        # Removing M2M table for field author_group on 'Initiative'
        db.delete_table(db.shorten_name(u'initiatives_initiative_author_group'))
